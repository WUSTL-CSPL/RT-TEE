...
#define TA_NAME		"pta_task6.pta"

int task6_execution_time = 0;
			...
			TEE_Param params[TEE_NUM_PARAMS] __unused)
{
	...
	mult_busy_loop(task6_execution_time); 
		...
		void **ppSessionContext __unused)
{
	...
	task6_execution_time = curr_task_params->execution_time;
...
pseudo_ta_register(.uuid = PTA_TASK6_UUID, .name = TA_NAME,
