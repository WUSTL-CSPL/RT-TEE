...
#define TA_NAME		"pta_task3.pta"


int task3_execution_time = 0;
			...
			TEE_Param params[TEE_NUM_PARAMS] __unused)
{
	...
	mult_busy_loop(task3_execution_time); 
	test_finish[get_current_core()][2] += 1;
	return TEE_SUCCESS;
}
		...
		void **ppSessionContext __unused)
{
	...
	task3_execution_time = curr_task_params->execution_time;
...
pseudo_ta_register(.uuid = PTA_TASK3_UUID, .name = TA_NAME,
