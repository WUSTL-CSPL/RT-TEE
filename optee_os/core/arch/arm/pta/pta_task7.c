...
#define TA_NAME		"pta_task7.pta"

int task7_execution_time = 0;
			...
			TEE_Param params[TEE_NUM_PARAMS] __unused)
{
	...
	mult_busy_loop(task7_execution_time); 
		...
		void **ppSessionContext __unused)
{
	...
	task7_execution_time = curr_task_params->execution_time;
...
pseudo_ta_register(.uuid = PTA_TASK7_UUID, .name = TA_NAME,
